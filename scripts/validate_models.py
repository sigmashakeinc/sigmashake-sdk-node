#!/usr/bin/env python3
"""Validate Node SDK TypeScript types against the OpenAPI spec.
...
Exit codes:
    0 = types match the OpenAPI spec
    1 = drift detected
"""
...
VALIDATOR = OPENAPI_ROOT / "scripts" / "validate_node_sdk.py"
SPEC = OPENAPI_ROOT / "openapi.yaml"
MODELS = SDK_ROOT / "src" / "models.ts"
